    ...
    return (
        <Layout className={backgroundClassName}>
            <Content>
                ...
                {visibleStep === 2 &&
                    <CoupletMasterStep2 theme={theme} voice={voice} setVoice={setVoice} setTheme={setTheme}
                ...
                <Layout>
                    <Content>
                        {!isFromBooth && <>
                            ...
                            <Row type="flex" gutter={16}>
                                <Col align="middle" span={24}>
                                    <Button onClick={() => window.location.href = 'https://d1d2ukegmn3q96.cloudfront.net/site/index.html?token=66227820-7c10-4ec9-9539-9f2989d751ff\n'} theme='solid' type='warning'
                        ...
                        <Row type="flex" gutter={8}>
                            <Col align="middle" span={24} className="hint"><p>访问AI展台参与更多线下游戏</p></Col>
                        </Row>
                        <Row type="flex" gutter={8}>
